...
class TestsElasticSearch(BaseElasticSearchTestCase):
    ...
    def test_composed_word_search(self):
        ...
        self.assertEqual(dutch_index["mappings"]["properties"]['title']['fields']['analyzed']["analyzer"],
                         "dutch_ngram")
        self.assertEqual(dutch_index["mappings"]["properties"]['title']['fields']['analyzed']["search_analyzer"],
                         "dutch_dictionary_decompound")
        for text_field in ["text", "description"]:
        ...
        self.assertEqual(english_index["mappings"]["properties"]['title']['fields']['analyzed']["analyzer"],
                         "english_ngram")
        self.assertEqual(english_index["mappings"]["properties"]['title']['fields']['analyzed']["search_analyzer"],
                         "english")
        for text_field in ["text", "description"]:
            self.assertEqual(
